document.addEventListener('DOMContentLoaded', function() {
            ...
            if (typeof gsap !== 'undefined' && typeof ScrollTrigger !== 'undefined') {
                ...
                intro
                    .from('.brand-mark', { opacity: 0, scale: 0.88, duration: 0.55 }, '-=0.35')
                    .from('.hero-badge', { opacity: 0, y: -18, duration: 0.65 }, '-=0.2')
                    .from('.hero-title', { opacity: 0, y: 34, duration: 0.85 }, '-=0.35')
                    .from('.hero-subtitle', { opacity: 0, y: 26, duration: 0.7 }, '-=0.45')
                    .from('.hero-slogan-box', { opacity: 0, x: -24, duration: 0.65 }, '-=0.4')
                    .from('.btn-hero-primary, .btn-hero-secondary', { opacity: 0, y: 18, duration: 0.6, stagger: 0.12 }, '-=0.35');
